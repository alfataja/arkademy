...
<body>
  ...
  $select="Select * from regions where id_regions='$id'";
  ...
  <div class="container">
    ...
    <form action="database/region_edit_proc.php" method="post">
    <table width="600" border="0">
    <input type="hidden" name="id" value="<?php echo $buff['id_regions'];?>" />
      <tr>
        <td> Nama Region </td>
        <td><input class="form-control" type="text" name="nama" value="<?php echo $buff['name'];?>" /></td>
      </tr>
